...
Begin VB.Form RptItemwiseSales 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Item Wise Sales Information"
   ClientHeight    =   3840
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5730
   Icon            =   "frmItemwiseSales.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   3840
   ScaleWidth      =   5730
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmItemwiseSales.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmItemwiseSales.frx":0E64
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmItemwiseSales.frx":173E
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "RptItemwiseSales"
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT ItemGroup as ITEM_Group,ItemCatagory as ITEM_CATAGORY,ItemCode " & _
                    "as ITEM_CODE,ItemName as ITEM_NAME, Rate as ITEM_RATE " & _
                    ",sum(Qty) as ITEM_QTY " & _
                    ",SUM(Qty*Rate) as TOTAL " & _
                    "From tblCashDetail where strDate='" & CurrentDate.Value & "' " & _
                    "And CActive = 'Active' And CPost = 'Posted' " & _
                    "GROUP BY ItemCode, ItemName, Rate, ItemCatagory,ItemGroup", cn, adOpenStatic, adLockReadOnly
     ...
     End If
      ...
      If OpCustomDate.Value = True Then
        ...
        rsMaster.Open "SELECT ItemGroup as ITEM_Group,ItemCatagory as ITEM_CATAGORY,ItemCode " & _
                    ...
                    ",sum(Qty) as ITEM_QTY " & _
                    ",SUM(Qty*Rate) as TOTAL " & _
                    "From tblCashDetail where strDate BETWEEN '" & FDate.Value & "' AND '" & TDate.Value & "' " & _
                    "And CActive = 'Active' And CPost = 'Posted' " & _
                    "GROUP BY ItemCode, ItemName, Rate, ItemCatagory,ItemGroup", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\ItemWiseSales.rpt"
  ...
  If OpCustomDate.Value = True Then
   ...
   End If
        ...
        objReport.Preview "Item Wise Sales Statement", , , , , 16777216 Or 524288 Or 65536
...
ErrH:
    ...
    Select Case Err.Number
        Case 20545
            MsgBox "Request cancelled by the user", vbInformation, "Item Wise Sales Statement Report"
        Case Else
            MsgBox "Error " & Err.Number & " - " & Err.Description, vbCritical, "Item Wise Sales Statement Report"
    End Select
End Sub
