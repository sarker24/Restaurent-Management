      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGeneralLedger.frx":006A
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmGeneralLedger.frx":00C8
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT     VID,VDate,AHead, Debit, Credit,  " & _
                    ...
                    "Posted " & _
                    "From Voucher " & _
                    "WHERE    VDate='" & CurrentDate.Value & "' AND Posted = 'Posted' and AHead='" & parseQuotes(CmbAHead) & "'", cn, adOpenStatic, adLockReadOnly
